...
public class UDPListener : MonoBehaviour
{
    ...
    void ParsePacket()
    {
        ...
        //Dependiendo del tipo de paquete, �ste contendr� cierta cantidad de datos
        //  -0 -> 5 datos     ->NA
        //  -1 -> 10 datos    ->NA
        //  -2 -> 15 datos    ->NA
        //  -3 -> 360 datos   ->Lidar Quality
        //  -4 -> 720 datos   ->Lidar Distances
        //  -5 -> 50 datos    ->Informaci�n general
        ...
        else if (cabecera == 5)
        {
            ...
            --Posicion x                        8 bytes
            --Posici�n y                        8 bytes
            --Posici�n x Objetivo               8 bytes
            --Posici�n y Objetivo               8 bytes
            --Encoder 32 uint32                 4 bytes
            --Estado 8bits  uint                1 byte
            --bater�a 8bits uint                1 byte
            --�ngulo 16 float                   4 bytes     
            --Angulo Objetivo 16 float          4 bytes
            --C�mara firma1 Detectada 1 byte    1 byte
            --C�mara firma1 x 8 bits            1 byte
            --C�mara firma1 y 8 bits            1 byte
            --C�mara firma2 Detectada 1byte     1 byte
            --C�mara firma2 x 8bits             1 byte
            --C�mara firma2 y 8bits             1 byte
            --ArrayTramo      8 bytes
            --tramo           1 byte
